...
const Footer = () => {
  return (
    <>
    <footer className="footer footer-center bg-base-200 text-base-content rounded p-10 mt-[250px]">
  <nav className="grid grid-flow-col gap-4 flex justify-center mt-5">
